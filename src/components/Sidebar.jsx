...
const DASHBOARDS = [
  { icon:'💼', label:'CEO',                  path:'/dashboard/ceo',              color:'#a78bfa' },
  { icon:'◎',  label:'Marketing Manager',    path:'/dashboard/marketing',        color:'#60a5fa' },
  { icon:'⇥',  label:'Marketer',             path:'/dashboard/marketer',         color:'#34d399' },
  { icon:'⬡',  label:'Social Media Manager', path:'/dashboard/social-media',     color:'#f472b6' },
  { icon:'📖', label:'Instructor',           path:'/dashboard/instructor',       color:'#fb923c' },
  { icon:'💬', label:'Customer Service',     path:'/dashboard/customer-service', color:'#a78bfa' },
]
      ...
      <div className={styles.scroll}>
        ...
        <div className={styles.group}>
          ...
          {PUBLIC_ITEMS.map(item => {
            ...
            return (
              <button key={item.label} className={`${styles.item} ${active ? styles.itemActive : ''}`}
